...
import { AddTypeModal, EditTypeModal } from '../modals';
import { deleteType } from '../../../../../../store/general/services';
...
const TypeTableToolbar = (props: EnhancedTableToolbarProps) => {
  ...
  return (
    ...
    >
      ...
      {isCreateModal && route === 'types' && (<AddTypeModal />)}
      {isEditModal && route === 'types' && (<EditTypeModal />)}
    </Toolbar>
  );
}

export default observer(TypeTableToolbar);
